...
call cheerful#HL("Visual",          g:bolero_dark.lghtln.accent1)
...
call cheerful#HL("VertSplit",       g:bolero_dark.lghtln.accent2)
call cheerful#HL("VertSplit",       g:bolero_dark.ui.base_bg)
if has('nvim')
  call cheerful#HL("VertSplit",     cheerful#flip(g:bolero_dark.lghtln.accent2))
...
call cheerful#HL("StatusLine",      cheerful#flip(g:bolero_dark.lghtln.accent1))
