...
function! bolero#config#HL(group, values)
  let cmd = "hi " . a:group
...
function! bolero#config#flip(color_def)
  let l:out = {}
...
let s:dark_syntax.inlay_hint = {'fg': 'Brown 400'}
...
let s:light_syntax.inlay_hint = {'fg': 'Lime 800'}
